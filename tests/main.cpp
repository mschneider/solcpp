...
TEST_CASE("Empty MangoAccount"){
  ...
  auto mangoGroup = solana::rpc::fromFile<mango_v3::MangoGroup>(path + "/group.json");
  auto mangoAccount = mango_v3::MangoAccount(solana::rpc::fromFile<mango_v3::MangoAccountInfo>(path + "/account.json"));
  auto mangoCache = solana::rpc::fromFile<mango_v3::MangoCache>(path + "/cache.json");
  auto initHealth = mangoAccount.getHealth(&mangoGroup, &mangoCache, mango_v3::HealthType::Init);
  CHECK_EQ(initHealth.toDouble(), 0);
  auto maintHealth = mangoAccount.getHealth(&mangoGroup, &mangoCache, mango_v3::HealthType::Maint);
  CHECK_EQ(maintHealth.toDouble(), 0);
  auto initRatio = mangoAccount.getHealthRatio(&mangoGroup, &mangoCache, mango_v3::HealthType::Init);
  CHECK_EQ(initRatio.toDouble(), 100);
  auto maintRatio = mangoAccount.getHealthRatio(&mangoGroup, &mangoCache, mango_v3::HealthType::Maint);
...
TEST_CASE("account1"){
  ...
  auto openOrders3 = solana::rpc::fromFile<serum_v3::OpenOrders>(path + "/openorders3.json");
  auto openOrders6 = solana::rpc::fromFile<serum_v3::OpenOrders>(path + "/openorders6.json");
  auto openOrders7 = solana::rpc::fromFile<serum_v3::OpenOrders>(path + "/openorders7.json");
  ...
  mangoAccount.spotOpenOrdersAccounts[get_address(path + "/openorders3.json")] = openOrders3;
  mangoAccount.spotOpenOrdersAccounts[get_address(path + "/openorders6.json")] = openOrders6;
  mangoAccount.spotOpenOrdersAccounts[get_address(path + "/openorders7.json")] = openOrders7;
...
TEST_CASE("account2"){
  ...
  auto openOrders2 = solana::rpc::fromFile<serum_v3::OpenOrders>(path + "/openorders2.json");
  auto openOrders3 = solana::rpc::fromFile<serum_v3::OpenOrders>(path + "/openorders3.json");
  ...
  mangoAccount.spotOpenOrdersAccounts[get_address(path + "/openorders2.json")] = openOrders2;
  mangoAccount.spotOpenOrdersAccounts[get_address(path + "/openorders3.json")] = openOrders3;
...
TEST_CASE("account5"){
  ...
  auto openOrders0 = solana::rpc::fromFile<serum_v3::OpenOrders>(path + "/openorders0.json");
  auto openOrders1 = solana::rpc::fromFile<serum_v3::OpenOrders>(path + "/openorders1.json");
  auto openOrders2 = solana::rpc::fromFile<serum_v3::OpenOrders>(path + "/openorders2.json");
  auto openOrders3 = solana::rpc::fromFile<serum_v3::OpenOrders>(path + "/openorders3.json");
  auto openOrders8 = solana::rpc::fromFile<serum_v3::OpenOrders>(path + "/openorders8.json");
  ...
  mangoAccount.spotOpenOrdersAccounts[get_address(path + "/openorders0.json")] = openOrders0;
  mangoAccount.spotOpenOrdersAccounts[get_address(path + "/openorders1.json")] = openOrders1;
  mangoAccount.spotOpenOrdersAccounts[get_address(path + "/openorders2.json")] = openOrders2;
  mangoAccount.spotOpenOrdersAccounts[get_address(path + "/openorders3.json")] = openOrders3;
  mangoAccount.spotOpenOrdersAccounts[get_address(path + "/openorders8.json")] = openOrders8;
...
TEST_CASE("account9"){
  ...
  auto openOrders1 = solana::rpc::fromFile<serum_v3::OpenOrders>(path + "/openorders1.json");
  auto openOrders5 = solana::rpc::fromFile<serum_v3::OpenOrders>(path + "/openorders5.json");
  auto openOrders6 = solana::rpc::fromFile<serum_v3::OpenOrders>(path + "/openorders6.json");
  auto openOrders10 = solana::rpc::fromFile<serum_v3::OpenOrders>(path + "/openorders10.json");
  auto openOrders11 = solana::rpc::fromFile<serum_v3::OpenOrders>(path + "/openorders11.json");
  auto openOrders12 = solana::rpc::fromFile<serum_v3::OpenOrders>(path + "/openorders12.json");
  auto openOrders13 = solana::rpc::fromFile<serum_v3::OpenOrders>(path + "/openorders13.json");
  ...
  mangoAccount.spotOpenOrdersAccounts[get_address(path + "/openorders1.json")] = openOrders1;
  mangoAccount.spotOpenOrdersAccounts[get_address(path + "/openorders5.json")] = openOrders5;
  mangoAccount.spotOpenOrdersAccounts[get_address(path + "/openorders6.json")] = openOrders6;
  mangoAccount.spotOpenOrdersAccounts[get_address(path + "/openorders10.json")] = openOrders10;
  mangoAccount.spotOpenOrdersAccounts[get_address(path + "/openorders11.json")] = openOrders11;
  mangoAccount.spotOpenOrdersAccounts[get_address(path + "/openorders12.json")] = openOrders12;
  mangoAccount.spotOpenOrdersAccounts[get_address(path + "/openorders13.json")] = openOrders13;
