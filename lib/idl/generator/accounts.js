...
function accountFieldClass(acc, writer) {
...
function accountClassJson(acc, writer) {
...
function accountClass(acc, writer) {
...
async function genAccountFiles(
    ...
    idl.accounts?.forEach((acc) => {
        ...
        accountFieldClass(acc, writers)
        accountClassJson(acc, writers)
        accountClass(acc, writers);
