...
public:
        ...
        std::size_t bytes_transferred)
    {
        ...
        std::cout << justSubscribed << " " << pendingSub.size() << std::endl;
        ...
        {
            std::cout << "Removing Subs" << std::endl;
    ...
    void do_write()
    {
        ...
        if (pendingSub.size() != 0)
        {
            ...
            justSubscribed = true;
            std::cout << "Write calls subscription" << std::endl;
    ...
    void add_callback(json &data)
    {
        ...
        {
            std::cout<<"Doesn't contain field result"<<std::endl;
    ...
    void remove_callback(json &data)
    {
        ...
        if (!data.contains(std::string{result}))
        {
            std::cout<<"Data doesn't contain result"<<std::endl;
        ...
        else
        {
            ...
            if (unsub_res)
            {
                ...
                std::cout<<"Removed from id map"<<std::endl;
    ...
    void call_callback(json &data)
    {
        ...
        // if subscription is not a key in data then it's not relevant
        std::string subscription = "subscription";
        if (!data["params"].contains(std::string{subscription}))
        {
            std::cout<<"data doesn't contain field subscription"<<std::endl;
            return;
        }
    ...
    void unsubscribe(int id)
    {
        ...
        // unsubscribing
        std::cout<<"Pushed for unsubscribing"<<std::endl;
...
public:
    ...
    void fill_available_commitment()
    {
        ...
        available_commitment.push_back("recent");
        available_commitment.push_back("single");
        available_commitment.push_back("singleGossip");
        available_commitment.push_back("root");
        available_commitment.push_back("max");
    }
        ...
        std::string commitment = "finalized")
    {
        ...
        RequestContent *req = new RequestContent(curr_id, "accountSubscribe", "accountUnsubscribe", account_change_callback, param);
...
int main()
{
    ...
    // json params2 = {"all"};
    // RequestContent *req1 = new RequestContent(
    //     1,
    //     "accountSubscribe",
    //     "accountUnsubscribe",
    //     display,
    ...
    // RequestContent *req2 = new RequestContent(
    //     3,
    //     "logsSubscribe",
    //     "logsUnsubscribe",
    //     display,
