...
#define b58_almostmaxint_bits (sizeof(b58_almostmaxint_t) * 8)
        ...
        static bool b58tobin(void *bin, size_t *binszp, const char *b58, size_t b58sz) {
            ...
            // std::cout << "b58tobin outisz:" << outisz << " b58sz:" << b58sz << " bytesleft:" << (int)bytesleft << " outisz:" << outisz << " zerocount:" << zerocount << std::endl;
        ...
        static std::string b58decode(const std::string &b58) {
        ...
        template<typename T>
        static std::string b58encode(const T &str) {
